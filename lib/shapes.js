...
class Triangle extends Shape {
    ...
    insertText () {
        return `<text x="75" y="85" text-anchor="middle" dominant-baseline="middle" fill="${this.textColor}">${this.text}</text>`
    }
...
class Circle extends Shape {
    ...
    insertShape () {
        return `<circle cx="75" cy="75" r="30" fill="${this.shapeColor}"/>`
    }
    insertText () {
